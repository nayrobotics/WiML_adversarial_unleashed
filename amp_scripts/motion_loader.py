...
from xRL.utils.transformations_utils import slerp_quat
from . import pose3d
from . import motion_util

#TODO Create a mask to loaf other type robot
...
class AMPLoader:
    ...
    def __init__(
        ...
        for i, motion_file in enumerate(motion_files):
            print("Opening motion file: " , motion_file)
    ...
    def get_full_frame_at_time_batch(self, traj_idxs, times):
        ...
        rot_blend = slerp_quat(all_frame_rot_starts, all_frame_rot_ends, blend)
    ...
    def blend_frame_pose(self, frame0, frame1, blend):
        ...
        blend_root_rot = transformations.slerp_quat(
    ...
    def feed_forward_generator(self, num_mini_batch, mini_batch_size):
        ...
        s_list = []  # List to store all s tensors
        s_next_list = []
        ...
        s_next_all = torch.cat(s_next_list, dim=0)
        
        return s_all, s_next_all            
